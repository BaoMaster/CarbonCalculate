...
namespace BlazorHero.CleanArchitecture.Infrastructure.Contexts
{
    public class BlazorHeroContext : AuditableContext
    {
        ...
        public DbSet<CarbonCalculateSet> CarbonCalculateSet { get; set; }
        public DbSet<CarbonCalculateAnswer> CarbonCalculateAnswer { get; set; }
        public DbSet<ConfigUnitValue> ConfigUnitValue { get; set; }
