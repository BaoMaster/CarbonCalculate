...
namespace BlazorHero.CleanArchitecture.Application.Features.CarbonCalculate.Commands.AddAnswer

{
    public partial class AddAnswerCommandd : IRequest<Result<int>>
    {
    ...
    internal class AddEditBrandCommandHandler : IRequestHandler<AddAnswerCommandd, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(AddAnswerCommandd command, CancellationToken cancellationToken)
        {
            if (command.Id == 0)
            {
